...
class hack_auto:
    ...
    def check_rc(self):
        ...
        if file_count > 5:
            cmd = input(
                "Rc folder contains files more than 5. Do you want to clean the dictionary(recomended=yes) y or n ? ~~> ")
            if "y" in cmd:
    ...
    def check_vulnerable(self):
        ...
        if file_count > 5:
            cmd = input(
                "Vulnerabilities folder contains files more than 5. Do you want to clean the dictionary(recomended=yes) y or n ? ~~> ")
            if "y" in cmd:
    ...
    def check_overall(self):
        ...
        if file_count > 5:
            cmd = input(
                "Overall_vulnerabilities folder contains files more than 5. Do you want to clean the dictionary(recomended=yes) y or n ? ~~> ")
            if "y" in cmd:
    ...
    def target(self):
        self.target_cmd = input(
            "|O|N|I|[Hacking-Automatic]['What is the target ip']~~> ")
    ...
    def process(self):
        ...
        response = os.system("ping -c 1 " + self.target_cmd +
                             " > ./"+self.actuall_folder+"/Ping.txt")
        if response == 0:
            print("Network Active")
            print("Proceeding layer scan with nmap.. This may take time..")
            os.system("nmap -sV "+self.target_cmd+" > ./" +
                      self.actuall_folder+"/Nmap_Result")
            sep_content1 = []
            with open("./"+self.actuall_folder+"/Nmap_Result", "r") as f:
                ...
                os.system("msfconsole -r ./data/rc/"+self.actuall_folder +
                          "_msf.rc -o ./data/vulnerabilities/"+self.actuall_folder+"_vulnerable.txt")
                separate_vul_1("./data/vulnerabilities/" +
                               self.actuall_folder+"_vulnerable.txt")
                separate_vul_2()
                overall("./data/overall_vul/"+self.actuall_folder +
                        "_auxiliary_scan_overall.txt")
                try:
                ...
                os.system("cp ./data/overall_vul/" + self.actuall_folder +
                          "_auxiliary_scan_overall.txt "+self.actuall_folder+"/Gatherings/")
                os.system("cp ./data/gobuster_"+self.actuall_folder +
                          ".txt "+self.actuall_folder+"/Gatherings/")
                os.system("cp ./data/rc/"+self.actuall_folder +
                          "_msf.rc "+self.actuall_folder+"/Gatherings/")
        ...
        #try:
            with open("./Reports/Report_"+self.actuall_folder+".txt", "w") as f, open("./"+self.actuall_folder+"/Target.txt", "r") as g, open("./"+self.actuall_folder+"/Nmap_Result", "r") as h, open("./"+self.actuall_folder+"/Ping.txt", "r") as i, open("./"+self.actuall_folder+"/Gatherings/"+self.actuall_folder+"_auxiliary_scan_overall.txt", "r") as j:
                ...
                l2 = f.write(
                    "8    8 8b   8 8        8   `8                            \n")
                l2 = f.write(
                    "8    8 8`b  8 8       o8YooP' .oPYo. .oPYo. .oPYo. odYo. \n")
                l2 = f.write(
                    "8    8 8 `b 8 8 ooooo  8   `b 8oooo8 8    ' 8    8 8' `8 \n")
                l2 = f.write(
                    "8    8 8  `b8 8        8    8 8.     8    . 8    8 8   8 \n")
                l2 = f.write(
                    "`YooP' 8   `8 8        8    8 `Yooo' `YooP' `YooP' 8   8 \n")
                l2 = f.write(
                    ":.....:..:::....:::::::..:::..:.....::.....::.....:..::..\n")
                l2 = f.write(
                    ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n")
                l2 = f.write(
                    ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n\n\n")
                l2 = f.write(
                    "       Internet Protocol Adress of the target:\n\n")
                for lines in g:
                    f.write(lines)
    ...
    def start_menu(self):
        while True:
            ...
            if "options" in self.menu_cmd:
                print(
                    "1-Automatic reconnaissance  -------> Assessment held by ONI---- To use type 'recon'")
...
class main:
    ...
    def display(self):
        print(
            " _______  _       _________     _______  _______  _______  _______  _       ")
        print(
        ...
        print(
            "| |   | || | \   |   | |       | (\ (   | (      | |      | |   | || | \   |")
        print(
            "| (___) || )  \  |___) (___    | ) \ \__| (____/\| (____/\| (___) || )  \  |")
        print(
            "(_______)|/    )_)\_______/    |/   \__/(_______/(_______/(_______)|/    )_)")
        print("\n")
